...
latex_documents = [
    (master_doc, "PolyglotDB.tex", "PolyglotDB Documentation", "PolyglotDB", "manual"),
]
...
man_pages = [(master_doc, "polyglotdb", "PolyglotDB Documentation", [author], 1)]
