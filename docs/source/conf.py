...
# -*- coding: utf-8 -*-
#
# PolyglotDB documentation build configuration file, created by
...
MOCK_MODULES = ['textgrid', 'textgrid.textgrid',
                ...
                'pyraat',
                'pyraat.parse_outputs',
                'conch',
                'praatio', 'praatio.utilities', 'praatio.utilities.errors',
                'conch.utils',
                'conch.analysis',
...
htmlhelp_basename = 'PolyglotDBdoc'
...
latex_documents = [
  (master_doc, 'PolyglotDB.tex', 'PolyglotDB Documentation',
   'PolyglotDB', 'manual'),
]
...
man_pages = [
    (master_doc, 'polyglotdb', 'PolyglotDB Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PolyglotDB', 'PolyglotDB Documentation',
   author, 'PolyglotDB', 'One line description of project.',
   'Miscellaneous'),
]
