from polyglotdb.query.annotations.attributes.base import AnnotationAttribute, key_for_cypher
...
class AggregateAttribute(AnnotationAttribute):
    ...
    def alias(self):
        ...
        return key_for_cypher(
            "{}_{}_{}".format(self.annotation.alias, self.label, self.aggregate.function)
        )
