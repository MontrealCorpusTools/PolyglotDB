...
with CorpusContext("timit", **graph_db) as g:
    ...
    q = (
        ...
        .columns(
            ...
            g.phone.word.utterance.phone.subset_type("syllabic").rate.column_name(
                "utterance_syllables_per_second"
            ),
            ...
            g.phone.word.phone.subset_type("syllabic").position.column_name(
                "word_syllable_position"
            ),
        )
    )
